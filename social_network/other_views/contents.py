...
from social_network.other_models.contents import Post, Tag, PostMedia
...
def create_post(request):
    if request.method == "POST":
        ...
        pictures = request.FILES["image-upload"]

        post = Post.objects.create(poster=request.user, caption=caption)
        #for picture in pictures:
        chat_media = PostMedia.objects.create(picture=pictures, post_id=post)
